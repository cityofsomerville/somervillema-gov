...
(function($){
	...
	function getFeed(type,id,path,o,obj,opt,f1,f2,intro,feed,fn){
		...
		switch (type) {
			...
			url = url = cp.length > 1 ? 'https://graph.facebook.com/'+cp[1]+'/photos?fields=id,link,from,name,picture,images,comments,posts&limit='+n : curl + '?id='+id+'&limit='+n;
			break;
				...
				if(error == ''){
					$.each(a, function(i,item){
						if(i < n){
							...
							u='<a href="'+href+'">'+id+'</a>',
							w='',
							x = '<a href="'+q+'">'+item.title+'</a>', y='', z='', zz='', m='', d = item.publishedDate, sq = q, st = item.title, s = '';
							switch(type)
							{
								case 'facebook':
								if(cp.length > 1){
							...
							$.each(o.out.split(','), function(i,v){
								...
								switch(v)
								{
									...
									if (type == 'facebook') {
									zintro= '<span class="section-'+v+'"><a href="'+q+'">'+decodeURIComponent(intro)+'</a> <span><a href="'+q+'">'+nicetime(new Date(d).getTime(),0)+'</a></span></span>'
									} else {
