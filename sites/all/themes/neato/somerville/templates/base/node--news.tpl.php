      ...
      <div class="columns columns">
        ...
        <div class="column column--75">
          <div class="rich-text-editor component">
            ...
            <?php if (isset($content['field_headline'])): ?>
              <h2 class="headline"><?php echo render($content['field_headline']); ?></h2>
            <?php endif ?>
            <div class="article-date">
	            <?php if (isset($content['field_submission_date'])):
                    print render($content['field_submission_date']);
                else:
                    print format_date($node->created, 'news_article_date');
                endif; ?>
            </div>
            <?php if (isset($content['field_news_image'])): ?>
              <div class="news-image">
                <?php echo render($content['field_news_image']); ?>
                <?php if($node->field_news_image['und'][0]['alt']): ?>
	                <span class="caption"><?php echo $node->field_news_image['und'][0]['alt']; ?></span>
	            <?php endif; ?>
              </div>
            <?php endif ?>
        ...
        <div class="column column page_bottom_100">
